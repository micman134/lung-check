...
if page == "Prediction":
    ...
    if uploaded_file is not None:
        ...
        st.image(test_image, caption="Processed Image", use_column_width=True)
    ...
    st.image('large.cell.carcinoma.png', caption="Large cell carcinoma Cance", use_column_width=True)
